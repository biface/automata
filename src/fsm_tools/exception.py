...
class AutomatonException(Exception):
    ...
    def __init__(
        self, grammar: str, component: str, action: str, locale: str = None, **event
    ) -> None:
        """
        ...
        self.message = generate_message(
            self.grammar, self.component, self.action, self.domains[0], self.locale
        )
