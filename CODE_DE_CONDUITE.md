...
Ce code de conduite s'applique à toute personne qui participe au projet **fsm-tools** ou
qui s'exprime publiquement à son sujet — dans le dépôt GitHub, les issues, les pull
requests, les discussions, et dans tout espace public où fsm-tools est le sujet.
