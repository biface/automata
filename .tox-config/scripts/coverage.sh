#!/usr/bin/env bash
# ==============================================================================
# coverage.sh - Génération du rapport de couverture de code
# ==============================================================================
#
# Lit .tox-config/coverage-version.txt pour déterminer quelle version Python
# utiliser pour générer le rapport de couverture.
#
# Usage:
...
#   1: Échec de génération du rapport
#
# ==============================================================================
